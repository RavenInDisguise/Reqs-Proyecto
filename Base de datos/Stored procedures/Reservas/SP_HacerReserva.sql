...
BEGIN
    ...
    BEGIN TRY
        ...
        IF [dbo].[BiblioTEC_FUNC_Choques](@IN_horaInicio, @IN_horaFin, NULL, @IN_idCubiculo, NULL) = 1
        BEGIN
            RAISERROR('Hay un choque con otra reserva en el cubículo seleccionado', 16, 1);
        END;

        IF [dbo].[BiblioTEC_FUNC_Choques](@IN_horaInicio, @IN_horaFin, @IN_idEstudiante, NULL, NULL) = 1
        BEGIN
